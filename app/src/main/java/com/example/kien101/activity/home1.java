...
import com.example.kien101.ultility.Constants;
import com.example.kien101.ultility.PreferenceManager;
...
public class home1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    Button createMap= findViewById(R.id.createMap);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> receivedCafeNames = getIntent().getStringArrayListExtra("cafeNames");
        if (receivedCafeNames != null) {
            addMarkersForCafes(receivedCafeNames);
//            hSearchMark();
        }
    ...
    private void addEvent() {
        createMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(home1.this, createMapEdge.class);
                startActivity(i);
            }
        });
...
//        btnHome = findViewById(R.id.btnHome);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mylc, 17));
...
//    private Marker cafeLocation;
    ...
    private void addMarkersForCafes(ArrayList<String> cafeNames) {
